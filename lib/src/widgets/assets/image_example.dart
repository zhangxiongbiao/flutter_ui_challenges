...
class ImageExample extends StatelessWidget {
  static const String path = "lib/src/widgets/assets/image_example.dart";
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: <Widget>[
          ...
          Card(
            child: Image.asset('assets/images/dart-side.png'),
          ),
          Divider(),
          ...
          Image.asset(
            'assets/images/animated_flutter_lgtm.gif',
            scale: 1.0,
            height: 300,
          ),
          Divider(),
